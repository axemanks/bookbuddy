          ...
          <div className='mx-auto max-w-7xl px-6 lg:px-8'>
            <div className='mx-auto max-w-2xl text-center'>
              <h1 className='text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl'>
                Wecome to the BookBuddy Demo
              </h1>
              <p className='mt-6 text-lg leading-8 text-gray-600'>
                Bookbuddy is a "context aware" chat bot. What does that mean? The bot knows what books are on the site books.toscrape.com and will suggest books and give links to them. It will only answer questions about books on that site.
              </p>
              <div>
              <p>Try it out!</p></div>
